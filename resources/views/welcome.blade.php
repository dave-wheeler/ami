<x-layout>
    ...
    <div class="flex items-center dark:text-white">
        ...
        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="10"
             viewBox="0 0 501.999 501.999" class="w-8 h-8">
            <path
    ...
    <div class="ml-12">
        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
            ...
            <ul>
                ...
                <li><a href="{{route('compare.form')}}">Compare Daily Usage by Date Ranges</a></li>
            </ul>
        </div>
    </div>
</x-layout>
